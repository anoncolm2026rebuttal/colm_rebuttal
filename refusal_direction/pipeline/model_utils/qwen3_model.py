...
# qwen 3 chat templates are based on
# - https://qwen.meta.com/docs/model-cards-and-prompt-formats/meta-qwen-3/
# <|begin_of_text|> is automatically added by the tokenizer

QWEN3_CHAT_TEMPLATE = """<|start_header_id|>user<|end_header_id|>

{instruction}<|eot_id|><|start_header_id|>assistant<|end_header_id|>

"""

QWEN3_CHAT_TEMPLATE_WITH_SYSTEM = """<|start_header_id|>system<|end_header_id|>
...
def format_instruction_qwen3_chat(
    ...
    if system is not None:
        formatted_instruction = QWEN3_CHAT_TEMPLATE_WITH_SYSTEM.format(instruction=instruction, system_prompt=system)
    else:
